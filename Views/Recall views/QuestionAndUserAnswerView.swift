...
struct QuestionAndUserAnswerView {
  @AppStorage("noOfTimeStamps") private var noOfTimeStampsString: String = "10"
      ...
      VStack {
        ...
        VStack {
          ...
          HStack {
            ...
            Spacer()
            MRAButton(label: "Show answer",
            isDisabled: filteredQuestions.count == 1) {
              showAnswer = true
            }
            Spacer()
            MRAButton(label: "Next question") {
              showAnswer = false
              userAnswer = ""

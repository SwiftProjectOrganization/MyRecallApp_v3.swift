...
\n\n4. Press "***< Back***" (or pull this sheet down) to return to the subtopic view.
\n\n5. Tap "**Update subtopic**" to modify the current category.
\n\n6. Tap "**Show subtopic links**" to select or update the links.
\n\n7. Tap "**Show subtopic recall timestamps**" to see the last 10 times this subtopic was included in a recall.
"""
